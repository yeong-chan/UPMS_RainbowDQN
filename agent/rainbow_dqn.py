...
class PrioritizedReplayBuffer(ReplayBuffer):
    ...
    def store(self, obs, act, rew, next_obs, done, ) -> Tuple:
    ...
    def sample_batch(self, beta=0.4) -> Dict:
...
class DQNAgent:
    ...
    # 수정필요
    def select_action(self, state: np.ndarray) -> np.int: # wo epsilon-greedy algorithm
    ...
    def step(self, action: np.int) -> Tuple[np.ndarray, np.float64, bool]:
    ...
    def train(self, num_episode: int, plotting_interval: int = 200):
        ...
        for e in range(1, num_episode + 1):
            ...
            while not done:
                ...
                # PER: increase beta
                fraction = min(e / num_episode, 1.0)
